...
\usepackage[upce]{common/theme} 
\usepackage{common/beamerthemeUpceFei} 			% základní beamer styly
...
\begin{frame}{Graf I.}
\begin{center}
	\smartdiagram[circular diagram:clockwise]{Stáhnout, Pochopit, Upravit, Publikovat}
\end{center}
\end{frame}
...
\smartdiagram[bubble diagram]{
    \textbf{UPCE},
    \textbf{FEI}, \textbf{FES}, \textbf{FR}, \textbf{FR}, \textbf{FZS}, \textbf{FCHT}, \textbf{DFJP}
}
...
\DTLloaddb{fruit}{test.csv} % možnost načítat z csv souboru
...
variable=\quantity,
outerlabel=\name,
innerlabel={\color{white}\DTLpiepercent\%}
}{fruit}{\name=Name,\quantity=Quantity}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Graf III.}
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        bar width=10pt,
        ymajorgrids = true,
        ylabel = {Average query duration (ms)},
        symbolic x coords={(FTIDX-TX), (IDX-TX), (NOIDX-TX), (FTIDX-NOTX), (IDX-NOTX), (NOIDX-NOTX)},
        xtick = data,
        xtick distance=1,
        ...
        ymin=0,
        nodes near coords,
        every node near coord/.append style={rotate=90, anchor=west, font={\small}, /pgf/number format/.cd,precision=0},
        ...
        \addplot+
       		[style={upce,fill=upce,mark=none}]
         	coordinates {
         		((FTIDX-TX),42.66)
				((IDX-TX),42.4)
				((NOIDX-TX),35.02)
